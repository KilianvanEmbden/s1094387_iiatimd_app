...
export 'character_view_model.dart';

class CharacterViewWidget extends StatefulWidget {
  const CharacterViewWidget({
    Key? key,
    this.character,
  }) : super(key: key);
  ...
  @override
  _CharacterViewWidgetState createState() => _CharacterViewWidgetState();
}

class _CharacterViewWidgetState extends State<CharacterViewWidget> {
  late CharacterViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharacterViewModel());
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.character!.reference.delete();
